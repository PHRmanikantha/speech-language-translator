...
def translate():
    ...
    try:
        ...
        messagebox.showerror("Error", "Translation failed. Try again.")
...
combo1.set("Choose language")

f1 = Frame(window, bg='black', bd=4)
f1.place(x=100, y=100, width=150, height=150)

text1 = Text(f1, font="Roboto 14", bg='black', relief=GROOVE, wrap=WORD)
...
text2 = Text(f2, font="Roboto 14", bg='black', relief=GROOVE, wrap=WORD)
